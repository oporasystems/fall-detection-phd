        ...
        while self.i < len(self.csv_files):
            ...
            try:
                ...
                required_columns = ['AccX', 'AccY', 'AccZ', 'acc_x_filtered', 'acc_y_filtered', 'acc_z_filtered',
                                    'Magnitude', 'acc_magnitude_filtered', 'Altitude', 'altitude_filtered']
                ...
                if all(col in data.columns for col in required_columns):
                    ...
                    # Create buttons
                    ax_next = plt.axes([0.7, 0.01, 0.1, 0.05])
                    ax_delete = plt.axes([0.81, 0.01, 0.1, 0.05])
...
if __name__ == "__main__":
    folder_path = '/Users/ivanursul/Downloads/ad'  # Replace with your folder path
